...
CKEDITOR.config.smiley_images = [
	...
	'embaressed_smile.gif','omg_smile.gif','whatchutalkingabout_smile.gif','angry_smile.gif','angel_smile.gif','shades_smile.gif',
	'devil_smile.gif','cry_smile.gif','lightbulb.gif','thumbs_down.gif','thumbs_up.gif','heart.gif',
	'broken_heart.gif','kiss.gif','envelope.gif','2guns.gif'];
...
CKEDITOR.config.smiley_descriptions =
	[
		'smiley', 'sad', 'wink', 'laugh', 'frown', 'cheeky', 'blush', 'surprise',
		'indecision', 'angry', 'angel', 'cool', 'devil', 'crying', 'enlightened', 'no',
		'yes', 'heart', 'broken heart', 'kiss', 'mail','guns','360', 'Arcade_Button_Kick', 'Arcade_Button_Punch', 'back', 'down', 'downback', 'downforward', 'dragonmove', 'dragonmoveb', 'forward', 'hcb', 'hcf', 'kick_hard', 'kick_light', 'kick_medium', 'punch_hard', 'punch_light', 'punch_medium', 'qcb', 'qcf', 'snka',
		'snkb', 'snkc', 'snkd', 'up', 'upback', 'upforward'
	];
